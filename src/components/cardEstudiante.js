...
// Definición del componente CardEstudiante
const CardEstudiante = ({ item }) => {
    return (
        ...
        <View style={styles.cardContainer}>
            ...
            <Text style={styles.nombre}>Nombre del estudiante: {item.nombre}</Text>
            {/* Carnet del estudiante */}
            <Text style={styles.text}>Carnet del estudiante: {item.carnet}</Text>
        </View>
    );
};
...
export default CardEstudiante;  // Exporta el componente CardComida para su uso en otras partes de la aplicación
